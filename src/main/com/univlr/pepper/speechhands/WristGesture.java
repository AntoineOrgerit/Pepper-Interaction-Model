...
/**
 * Represents a wrist gesture during the first automate test on the Pepper
 * robot.
 * 
 * @author Antoine Orgerit
 */
public class WristGesture extends Wrist {
	...
	public void setup() {
		...
		this.addBehaviour(new StateChartBehaviour(this, "WristGesture", (String) args[0]));
		this.side = (String) args[1];
	}

	/**
	 * Allows to rotate the wrist during the {@code WristGesture}.
	 * 
	 * @throws PepperActionException if an error occurred during the execution of
	 *                               the gesture.
	 */
	public void rotate() throws PepperActionException {
		super.rotate(this.side);
	}
